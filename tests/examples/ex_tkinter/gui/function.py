...
class showAdd:
    ...
    def add(self):
        ...
        res = function.add(self.a, self.b)
        lab = tk.Label(self.win, text=res)
        lab.place(x=50, y=150, width=100, height=30)
...
class showSub:
    ...
    def sub(self):
        ...
        res = function.sub(self.a, self.b)
        lab = tk.Label(self.win, text=res)
        lab.place(x=350, y=150, width=100, height=30)